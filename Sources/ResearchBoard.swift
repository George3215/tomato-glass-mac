...
private final class BoardSurface: GroupedSurface {}
...
final class ResearchCanvas: NSView {
    ...
    func color(_ kind: String) -> NSColor {
        switch kind { case "问题": return .systemPurple; case "观点", "Idea": return .systemOrange; case "实验": return SoftGlass.accent; case "结果": return .systemGreen; case "失败": return .systemRed; default: return .systemTeal }
    }
    ...
    override func draw(_ dirtyRect: NSRect) {
        SoftGlass.panel.withAlphaComponent(0.25).setFill(); bounds.fill()
