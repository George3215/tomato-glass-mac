...
xcrun swiftc -module-cache-path .build/module-cache Sources/Countdown.swift Sources/ActivityLog.swift Sources/ResearchGraph.swift Sources/ResearchModels.swift Sources/ResearchStore.swift Sources/ResearchBackup.swift Sources/FocusSessionCoordinator.swift Tests/Research/main.swift -lsqlite3 -o .build/research-tests
